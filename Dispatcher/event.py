...
class Cancellation(Event):
    ...
    def do(self, dispatcher: Dispatcher, monitor: Monitor) -> None:
...
class Pickup(Event):
    ...
    def __str__(self) -> str:
        ...
        """
        return "{} -- {}: PickUp".format(self.timestamp, self.rider)
...
class Dropoff(Event):
    ...
    def __str__(self) -> str:
        ...
        """
        return "{} -- {}: DropOff".format(self.timestamp, self.rider)
